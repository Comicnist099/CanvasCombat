...
export default function Register(props) {
    ...
    const createAccountHandler = async (e) => { // Evento que sucede cuando presionas el boton de registrar
        ...
        if (name === "" || nickName === "" || email === "" || pass === "" || passV === "") {
            ...
            if (file) {
                ...
                swal({title: "FELICIDADES", text: "¡Creaste tu primera cuenta!", icon: "success", buttons: "Si"}).then((respuesta) => {
                    if (respuesta) {
    ...
    return (<div data-aos="fade-up" data-aos-delay="450" className="p-5" id="registerSection">
        <div style={
            {
                textalign: "center",
                marginbottom: "46px"
