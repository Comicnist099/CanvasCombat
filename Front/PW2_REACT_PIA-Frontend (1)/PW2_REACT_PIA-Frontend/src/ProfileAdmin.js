...
export function ProfileAdmin(props) {
          ...
          <div class="container text-center">
            <div className="row">
              <div className="one">
                <br></br>
                <br></br>
                <h1 style={{ color: "white" }}>ADMINISTRADOR/A</h1>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="col-md-8 ">
                ...
                <div className="form-group mb-3">
                  <label style= {{color: "black"}}>Creación de cuenta</label>
                  <input
                    className="form-control"
                    type="email"
                    autocomplete="off"
                ...
                <div className="row">
                  <div className="col-sm-12 col-md-6">
                    <div className="form-group mb-3">
                      <label
                        style={{ display: passwordValidate1, color: "black"}}
                      >
                        Password
                      </label>
                      <input
