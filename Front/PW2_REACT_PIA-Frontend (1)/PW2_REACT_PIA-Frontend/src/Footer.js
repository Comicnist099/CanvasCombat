...
return (
    ...
    <div className="row">
        <div className="col-sm-6 col-md-4 footer-navigation"><a className="navbar-brand" href="/" style={{color: "rgb(255,255,255)", fontWeight: "bold", letterSpacing: "1px", borderStyle: "double"}}>&nbsp;CANVAS COMBAT&nbsp;</a>
        ...
        <div className="col-sm-6 col-md-4 footer-contacts">
            <div><span className="fa fa-map-marker footer-contacts-icon"> </span>
                <p><span className="new-line-span">Pedro de Alba, Niños Héroes</span> Ciudad Universitaria, 66451 San Nicolás de los Garza, N.L.</p>
            </div>
            <div><i className="fa fa-phone footer-contacts-icon"></i>
                <p className="footer-center-info email text-start"> 81 8329 4030</p>
            </div>
