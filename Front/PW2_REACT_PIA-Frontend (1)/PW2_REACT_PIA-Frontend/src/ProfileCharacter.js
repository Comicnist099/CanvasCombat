...
export function ProfileCharacter() { // ///////////IMAGEN////////////////
    const [
        {
            alt,
            src
                    ...
                    <div className="row"
                        ...
                        <div className="col-md-12 ">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-12 col-md-6">
                                    <div className="form-group mb-3">
                                        <p className="form-label">Descripcion
                                        </p>
                                        <textarea value={
                                                friends.descripcion
                                            }
                                ...
                                <div className="col-sm-12 col-md-6">
                                    <div className="form-group mb-3">
                                        <p className="form-label">Fecha de creacion
                                        </p>
                                        <input value={
                                            ...
                                            name="firstname"></input>
                                        <br></br>
                                        <p className="form-label">Character info:
                                        </p>
                        ...
                        <div class="card p-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="user d-flex flex-row align-items-center">
                                    ...
                                    <img src="https://i.imgur.com/hczKIze.jpg" width="30" class="user-img rounded-circle mr-2"></img>
                                    <span>
