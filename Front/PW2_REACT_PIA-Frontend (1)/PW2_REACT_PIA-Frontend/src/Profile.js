...
export function Profile(props) {
    ...
    const NavegateFuction = () => {
        window.location.assign("MisPersonajes?idUser=" + idUser)
    }
    // ///////////IMAGEN////////////////
    const [
        {
                ...
                <div className="container">
                    ...
                    <div id="navcol-6" className="collapse navbar-collapse flex-grow-0 order-md-first">
                        <ul className="navbar-nav me-auto">
                            ...
                            <li className="nav-item">
                                <input class="btn btn-dark" id="editButton" name="editButton " type="button" value="Mis Personajes"
                                    onClick={NavegateFuction}/>
                            </li>
                            <li className="nav-item">
                ...
                <div className="row">
                    <div className="col-md-12 content-right"
                        ...
                        <input class="btn btn-info" id="editButton" name="editButton " type="button" value="Editar Información"
                            onClick={editMode}/>
                        <input value="Cerrar Sesión" className="btn btn-danger" type="button"
